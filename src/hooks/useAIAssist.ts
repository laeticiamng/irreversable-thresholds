...
export const AI_ACTIONS_CONFIG: AIActionConfig[] = [
  // IRREVERSA
  {
    ...
    label: 'Structurer',
    description: 'Transformer un brouillon en seuil structuré',
    isPro: false,
    module: 'irreversa',
  },
  {
    id: 'irreversa_missing_fields',
    label: 'Repérer ce qui manque',
    description: 'Identifier les champs à compléter',
    isPro: false,
    module: 'irreversa',
  },
  {
    ...
    description: 'Proposer une structure de rapport',
    isPro: true,
    module: 'irreversa',
  },
  // NULLA
  {
    ...
    label: 'Structurer',
    description: 'Transformer un texte en absence + effet',
    isPro: false,
    module: 'nulla',
  },
  {
    id: 'nulla_detect_duplicates',
    label: 'Fusion & dédoublonnage',
    description: 'Identifier les absences similaires',
    isPro: true,
    module: 'nulla',
  },
  // THRESH
  {
    ...
    label: 'Tags & reformulation',
    description: 'Proposer des tags et reformuler',
    isPro: false,
    module: 'thresh',
  },
  {
    id: 'thresh_period_summary',
    label: 'Synthèse période',
    description: 'Synthétiser une période de captures',
    isPro: true,
    module: 'thresh',
  },
];
